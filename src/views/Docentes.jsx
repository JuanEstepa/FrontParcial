      ...
      <div className="container mx-auto p-4">
        <div className="flex flex-wrap justify-center gap-4">
          {data != null && data.length > 0 ? ( // Verifica si hay datos antes de realizar el mapeo
            data.map(
              (
                teacher // Mapea los datos y renderiza un div para cada plato
              ) => (
                <div
                  key={teacher.id} // Asigna la clave única del plato como el ID del plato
            ...
            <h1 className="text-white">No hay profesores inscritos</h1>
          )}
        </div>
      </div>
    </>
